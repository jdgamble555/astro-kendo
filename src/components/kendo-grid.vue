...
import { enComponentMessages, enCustomMessages } from './grid/en-US';
import { esComponentMessages, esCustomMessages } from './grid/es';
import { frComponentMessages, frCustomMessages } from './grid/fr';
...
const locale = computed(() => {
    if (localizationLanguage.value === 'Spanish') return 'es';
    if (localizationLanguage.value === 'French') return 'fr';
    return 'en';
});

const onLocalizationLanguageChange = (e) => {
    localizationLanguage.value = e;
};
</script>
  ...
  <div>
    <LocalizationProvider :language="localizationLanguage">
      <IntlProvider :locale="locale">
        <Grid @localizationLanguageChange="onLocalizationLanguageChange" />
      </IntlProvider>
    </LocalizationProvider>
  </div>
</template>